...
<createTransactionRequest xmlns="AnetApi/xml/v1/schema/AnetApiSchema.xsd">
      <merchantAuthentication>
        <name>84STGuhg45XG</name>
        <transactionKey>2LQ99Ambt75U6W3u</transactionKey>
      </merchantAuthentication>
      <transactionRequest>
...
$transRequestXml->transactionRequest->payment->opaqueData->dataDescriptor = $_POST['dataDescriptor'];
...
$url = "https://api.authorize.net/xml/v1/request.api";      // Prod
